...
def get_user_list(__init__, key):
    with open("{}/ReyzuRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[ReyzuRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[ReyzuRobot]')
LOGGER.info("Reyzu is starting. | An Reyzu Robot Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/Reyzuuu (t.me/ReyzuRobot)")
...
if ENV:
    ...
    MONGO_DB = os.environ.get("MONGO_DB", "Reyzu Robot")
    ...
    from ReyzuRobot.config import Development as Config
...
from ReyzuRobot.modules.sql import SESSION
...
try:
    from ReyzuRobot.antispam import antispam_restrict_user, antispam_cek_user, detect_user
...
from ReyzuRobot.modules.helper_funcs.handlers import (
