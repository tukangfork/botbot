...
from ReyzuRobot.modules.helper_funcs.decorators import Reyzucmd, Reyzumsg
from ReyzuRobot.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from ReyzuRobot.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@Reyzucmd(command="antich", group=100)
...
@Reyzumsg(Filters.chat_type.groups, group=110)
