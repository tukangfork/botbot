...
async def _(event):
    ...
    im1 = Image.open("ReyzuRobot/resources/Reyzu.png")
    if ik.endswith(".tgs"):
        await tbot.download_media(reply, "Reyzu.tgs")
        os.system("lottie_convert.py Reyzu.tgs json.json")
        json = open("json.json", "r")
        jsn = json.read()
        jsn = jsn.replace("512", "2000")
        open = ("json.json", "w").write(jsn)
        os.system("lottie_convert.py json.json Reyzu.tgs")
        file = "Reyzu.tgs"
        os.remove("json.json")
