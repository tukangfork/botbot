...
from ReyzuRobot import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, DRAGONS
...
from ReyzuRobot.modules.helper_funcs.chat_status import user_admin, connection_status
from ReyzuRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ReyzuRobot.modules.helper_funcs.msg_types import get_note_type
...
❧ /save <notename>*:* save the replied message as a note with name notename Separate diff replies by `%%%` to get random notes
 *Example :* `/save notename.
