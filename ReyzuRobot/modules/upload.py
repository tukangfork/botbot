...
from ReyzuRobot import telethn as bot
from ReyzuRobot.modules.urluploader import download_file
from ReyzuRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @ReyzuRobot",
            )
        except Exception as e:
            traceback.print_exc()
