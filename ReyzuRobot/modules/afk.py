...
from ReyzuRobot.modules.sql import afk_sql as sql
from ReyzuRobot.modules.users import get_user_id
...
def afk(update: Update, context: CallbackContext):
    ...
    try:
        update.effective_message.reply_text("{} sekarang telah AFK!{}".format(fname, notice))
    except BadRequest:
        pass
