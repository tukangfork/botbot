...
import ReyzuRobot.modules.sql.notes_sql as sql
from ReyzuRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ReyzuRobot.__main__ import DATA_IMPORT
from ReyzuRobot.modules.helper_funcs.chat_status import user_admin
from ReyzuRobot.modules.helper_funcs.alternate import typing_action

# from ReyzuRobot.modules.rules import get_rules
import ReyzuRobot.modules.sql.rules_sql as rulessql

# from ReyzuRobot.modules.sql import warns_sql as warnssql
import ReyzuRobot.modules.sql.blacklist_sql as blacklistsql
from ReyzuRobot.modules.sql import disable_sql as disabledsql

# from ReyzuRobot.modules.sql import cust_filters_sql as filtersql
# import ReyzuRobot.modules.sql.welcome_sql as welcsql
import ReyzuRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("Reyzu Robot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Reyzu Robot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Reyzu Robot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Reyzu Robot{}.backup".format(chat_id))  # Cleaning file
